                ...
                <div class="sign-in-main-wrapper">
                    ...
                    <form class="sign-in-form" action="#" method="POST">
                        ...
                        <div class="form-group">
                            <label data-testid="user-email-label" for="user-email">Votre addresse e-mail</label>
                        ...
                        <div class="form-group">
                            <label data-testid="user-password-label" for="user-password">Votre mot de passe</label>
